...
function Security.IsItemAllowed(Item, Player)
	...
	local IsItemClassAllowed = (Item:IsA("BasePart") and not Item:IsA("Terrain"))
		or (Item:IsA("Model") and not Item:IsA("Workspace"))
		or Item:IsA("Folder")
		or Item:IsA("Smoke")
		or Item:IsA("Fire")
		or Item:IsA("Sparkles")
		or Item:IsA("DataModelMesh")
		or Item:IsA("Decal")
		or Item:IsA("Texture")
		or Item:IsA("Light")
	...
	if
		Item:FindFirstAncestorWhichIsA("Model")
		and game.Players:GetPlayerFromCharacter(Item:FindFirstAncestorWhichIsA("Model"))
	then
		if
			Options.PlayerTolerance == 1
			and game.Players:GetPlayerFromCharacter(Item:FindFirstAncestorWhichIsA("Model")) == Player
		then
			return true
