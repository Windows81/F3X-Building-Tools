...
if Mode == "Plugin" then
	...
	PluginButton = Plugin:CreateToolbar("Fork3X Building Tools by Vikko151")
		:CreateButton("Building Tools by F3X", "Building Tools by F3X", Assets.PluginIcon)
...
elseif Mode == "Tool" then
	...
	Tool.AncestryChanged:Connect(function(Item, Parent)
		if
			not Parent
			or not (Parent:IsA("Backpack") or (Parent:IsA("Model") and Players:GetPlayerFromCharacter(Parent)))
		then
			Disable()
		end
	end)
