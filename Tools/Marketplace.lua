...
function ShowUI()
	...
	-- Create the UI
	local UIClone = Core.Tool.Interfaces.BTMarketplaceGUI:Clone();
	UIClone.Parent = Core.UI;
	UIClone.Visible = true;

	-- References to UI elements
	local DecalButton = UIClone.Status.Decals.Button;
	local MeshButton = UIClone.Status.Meshes.Button;
	local SearchBox = UIClone.Search.SearchBox.SearchInput
	...
	local SignatureButton = UIClone:WaitForChild('Title'):WaitForChild('Signature')
