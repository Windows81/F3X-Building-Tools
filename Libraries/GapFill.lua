...
local copyPartProps = function(fromPart: BasePart, toPart: BasePart)
...
local function doFill(edgeA, edgeB, extrudeDirectionModifier: number, thicknessOverride: number?, forceFactor: number, PermissionFunction)
