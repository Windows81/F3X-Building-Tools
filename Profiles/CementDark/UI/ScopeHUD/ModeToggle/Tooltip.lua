...
local function Tooltip(props)
    return new('ImageLabel', {
        ...
        Size = UDim2.new(0, TITLE_SIZE.X + 45/2 + HOTKEY_SIZE.X + 22/2, 0, 94/2);
    ...
    },
    {
        ...
        Title = new('TextLabel', {
			...
			RichText = true;
			Text = '<font family="rbxassetid://12187365977">' .. 'Selection mode' .. '</font>';
        ...
        Hotkey = new('TextLabel', {
			...
			TextTransparency = 0;
			RichText = true;
			Text = '<font family="rbxassetid://12187365977">' .. 'SHIFT-T' .. '</font>';
        ...
        ScopedLabel = new('TextLabel', {
			...
			TextColor3 = Color3.new(1, 1, 1);
			RichText = true;
			Text = '<font family="rbxassetid://12187365977">' .. 'Groups and parts' .. '</font>';
        ...
        DirectLabel = new('TextLabel', {
			...
			TextColor3 = Color3.new(1, 1, 1);
			RichText = true;
			Text = '<font family="rbxassetid://12187365977">' .. 'Parts only' .. '</font>';
