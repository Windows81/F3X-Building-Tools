...
function Dock:render()
	return new('Frame', {
		...
		Position = UDim2.new(1, -10, 0.654, -82);
		Size = UDim2.new(0, 70, 0.3444444444444444, 182); -- Actually 69 x 488 pixels on 1920x1080!
		ZIndex = 0;
	}, {
    ...
    --[[        [Roact.Ref] = function (rbx)
		...
		Ratio = new('UIAspectRatioConstraint', {
			AspectRatio = 0.1340996168582375;
