...
function Dropdown:render()
    return new('ImageButton', {
        ...
        Options = new('ScrollingFrame', {
            ...
            Size = UDim2.new(
				math.ceil(#self.props.Options / self.props.MaxRows) <= 3 and math.ceil(#self.props.Options / self.props.MaxRows) or 3, 0,
                (#self.props.Options > self.props.MaxRows) and self.props.MaxRows or #self.props.Options, 12
            );
			ZIndex = 2;
            ...
            Layout = new('UIGridLayout', {
				...
				CellSize = UDim2.new(1 / math.ceil(#self.props.Options / self.props.MaxRows), 0, 1 / self.props.MaxRows, -12 / self.props.MaxRows);
